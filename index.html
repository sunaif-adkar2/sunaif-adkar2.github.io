...
def creator():
    ...
    start_inst1 = large_font.render("Sunaif Adkar", False, GREEN)
    start_inst1_rect = start_inst1.get_rect()
    start_inst1_rect.center = (WINDOW_WIDTH/2, 420)
    canvas.blit(start_inst1, start_inst1_rect)

    start_inst2 = small_font.render("Hello guys, This is Sunaif Adkar.Thanks for playing my game.", True, BLUE)
    start_inst3 = small_font.render("This is a very simple game, developed using python", True, BLUE)
    start_inst4 = small_font.render("In case of queries, write to https://t.me/sunaif_adkar", True, BLUE)
